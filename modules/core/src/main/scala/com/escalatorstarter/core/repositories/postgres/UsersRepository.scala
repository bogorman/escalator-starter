...
// GENERATED AT: 18-09-25 17:13:12:307
...
import com.escalatorstarter.persistence.postgres.tables.PostgresUsersTable

class UsersRepository(database: PostgresDatabase)(implicit logger: Logger, monitoring: Monitoring, eventBus: EventBus)
    extends PostgresUsersTable(database) {

  // Override methods here to add custom repository logic
  // This class inherits all standard CRUD operations from PostgresUsersTable
