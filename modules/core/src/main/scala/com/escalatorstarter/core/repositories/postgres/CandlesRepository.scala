...
// GENERATED AT: 18-09-25 17:13:12:252
...
import com.escalatorstarter.persistence.postgres.tables.PostgresCandlesTable

class CandlesRepository(database: PostgresDatabase)(implicit logger: Logger, monitoring: Monitoring, eventBus: EventBus)
    extends PostgresCandlesTable(database) {

  // Override methods here to add custom repository logic
  // This class inherits all standard CRUD operations from PostgresCandlesTable
