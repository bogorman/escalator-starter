...
// GENERATED AT: 24-10-25 12:59:33:187
...
import com.escalatorstarter.persistence.postgres.tables.PostgresCommentsTable

class CommentsRepository(database: PostgresDatabase)(implicit
    logger: Logger,
    monitoring: Monitoring,
    eventBus: EventBus
) extends PostgresCommentsTable(database) {

  // Override methods here to add custom repository logic
  // This class inherits all standard CRUD operations from PostgresCommentsTable
