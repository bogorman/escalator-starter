...
// GENERATED AT: 18-09-25 17:13:12:313
...
import com.escalatorstarter.persistence.postgres.tables.PostgresWorkQueuesTable

class WorkQueuesRepository(database: PostgresDatabase)(implicit
    logger: Logger,
    monitoring: Monitoring,
    eventBus: EventBus
) extends PostgresWorkQueuesTable(database) {

  // Override methods here to add custom repository logic
  // This class inherits all standard CRUD operations from PostgresWorkQueuesTable
