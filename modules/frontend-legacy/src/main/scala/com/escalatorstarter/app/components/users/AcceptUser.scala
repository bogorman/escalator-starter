// package frontendlegacy.app.components.users

// import com.raquo.laminar.api.L._
// import com.raquo.laminar.nodes.ReactiveHtmlElement
// import escalator.frontend.app.components.Component
// import escalator.frontend.app.router.Router
// import frontendlegacy.app.utils.{ActorSystemContainer, InfoDownloader}
// import frontendlegacy.utils.http.DefaultHttp._
// import io.circe.generic.auto._
// import com.escalatorstarter.users.PendingRegistration
...
//     boilerplate
//       .post(
//         pathWithMultipleParams(queryParamForUser.createParams(userName, randomKey).mapValues(_.content).toMap, "accept-user")
//       )
//       .response(ignore)
//       .send()
//       .map(_.is200)
...
//     boilerplate
//       .post(
//         pathWithMultipleParams(queryParamForUser.createParams(userName, randomKey).mapValues(_.content).toMap, "reject-user")
//       )
//       .response(ignore)
//       .send()
//       .map(_.is200)
...
//     val $maybeEmail: Observable[Option[String]] = Val(None)
