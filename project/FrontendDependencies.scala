...
object FrontendDependencies {
    ...
    val akkaJsVersion: Def.Initialize[Seq[ModuleID]] = Def.setting {
      Seq(
        //maybe bad!!
        "com.lihaoyi" %% "geny_sjs1" % "1.1.1",
        "org.akka-js" %%% "akkajsactor" % Versions.akkaJsVersion exclude("com.lihaoyi", "geny_sjs1_2.13"),
        "org.akka-js" %%% "akkajsactorstream" % Versions.akkaJsVersion exclude("com.lihaoyi", "geny_sjs1_2.13")
      )
    }  
